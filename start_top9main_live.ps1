...
$templateConfigPath = Join-Path $repoRoot "user_data\config.live.futures.top9.main.json"
$runtimeConfigPath = Join-Path $repoRoot "user_data\config.live.futures.top9.main.runtime.json"
$containerService = "freqtrade"
$baseUrl = "http://127.0.0.1:8084"
$apiUser = "Freqtrader"
$apiPassword = "Top9MainLive!2026"
$liveDbPath = "/freqtrade/user_data/tradesv3-top9-main-live.sqlite"
...
$composeEnv = @{
    ...
    FREQTRADE_STRATEGY = "Top9RegimeMainLiveStrategy"
}
...
try {
    ...
    Write-Host ""
    Write-Host "Top9 main live bot started." -ForegroundColor Green
