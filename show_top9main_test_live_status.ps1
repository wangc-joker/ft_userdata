...
$username = "Freqtrader"
$password = "Top9TestLive!2026"
$strategyName = "Top9RegimeMainTestLiveStrategy"
...
try {
    ...
    Write-Host "Unable to connect to the Top9 test-live API." -ForegroundColor Red
    Write-Host $_.Exception.Message -ForegroundColor Yellow
    Write-Host ""
    Write-Host "If it is not running yet, start it with: D:\test\ft_userdata\start_top9main_test_live.cmd [secrets path]"
    exit 1
}
...
Write-Host ""
Write-Host "Top9 test-live status" -ForegroundColor Cyan
Write-Host "------------------------------"
