from CombinedTrendCaptureMilestoneV2Top9VolAdjustedStrategy import (
    CombinedTrendCaptureMilestoneV2Top9VolAdjustedStrategy,
)


class CombinedTrendCaptureMilestoneV2Top9VolAdjustedTighterRiskStrategy(
    CombinedTrendCaptureMilestoneV2Top9VolAdjustedStrategy
):
    """
    Combine volatility-adjusted position sizing with stricter protections.
    """
